package org.sm0x.openfitnesstracker.config;

import org.sm0x.openfitnesstracker.security.*;
import org.sm0x.openfitnesstracker.security.jwt.*;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/api/application-settings").hasAnyAuthority(AuthoritiesConstants.ADMIN)
