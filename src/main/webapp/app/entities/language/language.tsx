...
export const Language = (props: ILanguageProps) => {
  ...
  const { languageList, match, loading } = props;
  return (
    <div>
      <h2 id="language-heading">
        <Translate contentKey="openfitnesstrackerApp.language.home.title">Languages</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="openfitnesstrackerApp.language.home.createLabel">Create new Language</Translate>
        </Link>
      </h2>
        ...
        {languageList && languageList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="openfitnesstrackerApp.language.home.notFound">No Languages found</Translate>
            </div>
          )
        )}
      </div>
