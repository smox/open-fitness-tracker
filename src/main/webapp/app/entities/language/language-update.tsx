  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="openfitnesstrackerApp.language.home.createOrEditLabel">
            <Translate contentKey="openfitnesstrackerApp.language.home.createOrEditLabel">Create or edit a Language</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : languageEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="shortNameLabel" for="language-shortName">
                  <Translate contentKey="openfitnesstrackerApp.language.shortName">Short Name</Translate>
                </Label>
                <AvField id="language-shortName" type="text" name="shortName" />
              </AvGroup>
