...
export const LanguageDeleteDialog = (props: ILanguageDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="openfitnesstrackerApp.language.delete.question">
        <Translate contentKey="openfitnesstrackerApp.language.delete.question" interpolate={{ id: languageEntity.id }}>
