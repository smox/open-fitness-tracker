...
export const MediaDeleteDialog = (props: IMediaDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="openfitnesstrackerApp.media.delete.question">
        <Translate contentKey="openfitnesstrackerApp.media.delete.question" interpolate={{ id: mediaEntity.id }}>
