...
export const WorkoutDeleteDialog = (props: IWorkoutDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="openfitnesstrackerApp.workout.delete.question">
        <Translate contentKey="openfitnesstrackerApp.workout.delete.question" interpolate={{ id: workoutEntity.id }}>
